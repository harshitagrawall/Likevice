...
import 'package:likevice/screens/setting_privacy.dart';
      ...
      child: Container(
        child: Column(
          ...
          children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                        ...
                        child: Text('See your profile', style: TextStyle(color: Colors.grey),))
                  ],
                ),
              ],
            ),
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Icon(Icons.person_2_outlined, color: Colors.blue, size: 30.0),
                        SizedBox(height: 5.0),
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Icon(Icons.person_sharp, color: Colors.blue, size: 30.0),
                        SizedBox(height: 5.0),
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=> SettingAndPrivacy()));
              },
              child: Container(
                width: MediaQuery.of(context).size.width,
                height: 65.0,
